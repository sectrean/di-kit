...
func (_m *ScopeMock) Contains(t reflect.Type, opts ...di.ContainsOption) bool {
	...
	var r0 bool
	if rf, ok := ret.Get(0).(func(reflect.Type, ...di.ContainsOption) bool); ok {
		r0 = rf(t, opts...)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
func (_c *ScopeMock_Contains_Call) Run(run func(t reflect.Type, opts ...di.ContainsOption)) *ScopeMock_Contains_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]di.ContainsOption, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
				variadicArgs[i] = a.(di.ContainsOption)
			}
		}
...
func (_c *ScopeMock_Contains_Call) RunAndReturn(run func(reflect.Type, ...di.ContainsOption) bool) *ScopeMock_Contains_Call {
	_c.Call.Return(run)
	return _c
}
